...
import holo_freq from '../img/holo_freq.png';
import Hololive_worldcloud from '../img/Hololive_worldcloud.png';
import time_freq from '../img/Rplot01.png';
...
function Page1() {
  ...
  const numberData = [
    { title: 'How Many Articles?', value: 1324, color: '#6729E5' },
    { title: 'Average Comments', value: 3.87, color: '#e56729' },
    { title: 'Average Like', value: 2.36, color: '#29e567' },
  ];
        ...
        <Grid item xs={12} sm={6}>
          <Card sx={{ height: '70%', bgcolor: 'background.paper', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            <CardContent style={{ position: 'relative', height: '100%', textAlign: 'center' }}>
              ...
              >
                <img src={Hololive_worldcloud} alt="Data 1" style={{ maxWidth: '100%', maxHeight: '100%', display: 'block', margin: 'auto' }} />
            ...
            <Grid item xs={12}>
              <Card sx={{ height: '100%', bgcolor: 'background.paper', position: 'relative' }}>
                <CardContent style={{ position: 'relative' }}>
                  ...
                  >
                    <img src={holo_freq} alt="Data 2" style={{ width: '100%', height: 'auto' }} />
